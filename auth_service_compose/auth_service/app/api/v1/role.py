...
class Roles(Resource):
    ...
    def post(self) -> Response:
        role_service = get_role_service()
        db_role = role_service.create_role(role_params=role_parser.parse_args())
...
class RoleId(Resource):
    ...
    def put(self, role_id: str) -> Response:
        ...
        role_service.update_role(
            role_id=role_id,
            role_params=role_parser.parse_args(),
        )
    ...
    def get(self, role_id: str) -> Response:
        ...
        if not db_role:
            raise NotFound(responses.CANT_FIND_ROLE)
