...
class User(sqlalchemy.Model, IdMixin, SerializerMixin):
    ...
    def set_password(self, password: str):  # noqa: WPS615
...
class RefreshToken(sqlalchemy.Model, IdMixin, UserIdMixin, SerializerMixin):  # noqa: WPS215
...
class Oauth(sqlalchemy.Model, IdMixin, UserIdMixin, SerializerMixin):  # noqa: WPS215
    __tablename__ = 'oauth'

    type = sqlalchemy.Column(
        sqlalchemy.Enum(OAuthEnum),
        nullable=False,
    )
