...
auth_token_view = Blueprint('jwt_', __name__, template_folder='templates')


@auth_token_view.route('/logout', methods=['GET'])
@jwt_required()
@log_activity(action=ActionsEnum.logout)
@trace_decorator()
def logout():  # noqa: WPS210
